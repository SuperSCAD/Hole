...
class HoleCounterboredTest(ScadTestCase):
    """
    Test cases for HoleCounterbored.
    """
    ...
    def test_alignment(self):
        ...
        hole3 = HoleCounterbored(height=10.0,
                                 diameter=1.0,
                                 counterbore_diameter=3.0,
                                 counterbore_height=1.5,
