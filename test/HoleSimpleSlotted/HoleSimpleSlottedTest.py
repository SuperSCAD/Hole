...
from super_scad_hole.HoleSimpleSlotted import HoleSimpleSlotted
from test.ScadTestCase import ScadTestCase


class HoleSimpleSlottedTest(ScadTestCase):
    """
    Test cases for HoleSimpleSlotted.
    """
    ...
    def test_alignment(self):
        ...
        hole1 = HoleSimpleSlotted(height=10.0, diameter=1.0, center_to_center=3.0, alignment=HoleAlignment.TOP)

        hole2 = HoleSimpleSlotted(height=10.0, diameter=1.0, center_to_center=3.0, alignment=HoleAlignment.CENTER)
        hole2 = Translate3D(x=5.0, child=hole2)

        hole3 = HoleSimpleSlotted(height=10.0, diameter=1.0, center_to_center=3.0, alignment=HoleAlignment.BOTTOM)
    ...
    def test_alignment_with_profiles(self):
        ...
        hole1 = HoleSimpleSlotted(height=10.0,
                                  diameter=1.0,
        ...
        hole2 = HoleSimpleSlotted(height=10.0,
                                  diameter=1.0,
                                  center_to_center=3.0,
        ...
        hole3 = HoleSimpleSlotted(height=10.0,
                                  diameter=1.0,
                                  center_to_center=3.0,
