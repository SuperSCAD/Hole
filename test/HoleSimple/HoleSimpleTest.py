...
from super_scad_hole.HoleSimple import HoleSimple
from test.ScadTestCase import ScadTestCase


class HoleSimpleTest(ScadTestCase):
    """
    Test cases for HoleSimple.
    """

    # ------------------------------------------------------------------------------------------------------------------
    def test_alignment(self):
        """
        Test the alignment of a simple hole.
        """
        scad = Scad(context=Context(fn=360, eps=0.35, vpr=Vector3(90.0, 0.0, 0.0)))

        hole1 = HoleSimple(height=10.0, diameter=1.0, alignment=HoleAlignment.TOP)

        hole2 = HoleSimple(height=10.0, diameter=1.0, alignment=HoleAlignment.CENTER)
        hole2 = Translate3D(x=5.0, child=hole2)

        hole3 = HoleSimple(height=10.0, diameter=1.0, alignment=HoleAlignment.BOTTOM)
