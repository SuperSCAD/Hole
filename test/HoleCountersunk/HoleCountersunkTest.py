...
class HoleCountersunkTest(ScadTestCase):
    """
    Test cases for HoleCountersunk.
    """
    ...
    def test_alignment(self):
        ...
        hole1 = HoleCountersunk(height=10.0, diameter=1.0, countersink_diameter=3.0, alignment=HoleAlignment.TOP)

        hole2 = HoleCountersunk(height=10.0, diameter=1.0, countersink_diameter=3.0, alignment=HoleAlignment.CENTER)
        hole2 = Translate3D(x=5.0, child=hole2)

        hole3 = HoleCountersunk(height=10.0, diameter=1.0, countersink_diameter=3.0, alignment=HoleAlignment.BOTTOM)
    ...
    def test_alignment_with_profiles(self):
        ...
        hole2 = HoleCountersunk(height=10.0,
                                diameter=2.0,
                                countersink_diameter=4.0,
        ...
        hole3 = HoleCountersunk(height=10.0,
                                diameter=2.0,
                                countersink_diameter=4.0,
