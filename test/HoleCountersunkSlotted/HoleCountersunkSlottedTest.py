...
from super_scad_hole.HoleCountersunkSlotted import HoleCountersunkSlotted
from test.ScadTestCase import ScadTestCase


class HoleCountersunkSlottedTest(ScadTestCase):
    """
    Test cases for HoleCountersunkSlotted.
    """
    ...
    def test_alignment(self):
        ...
        hole1 = HoleCountersunkSlotted(height=10.0,
                                       diameter=1.0,
                                       center_to_center=6.0,
                                       countersink_diameter=3.0,
                                       alignment=HoleAlignment.TOP)

        hole2 = HoleCountersunkSlotted(height=10.0,
                                       diameter=1.0,
                                       center_to_center=6.0,
                                       countersink_diameter=3.0,
        ...
        hole3 = HoleCountersunkSlotted(height=10.0,
                                       diameter=1.0,
                                       center_to_center=6.0,
                                       countersink_diameter=3.0,
